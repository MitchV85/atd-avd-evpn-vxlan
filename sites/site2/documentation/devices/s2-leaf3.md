...
| Ethernet4 | s2-host2_eth1 | *access | *10 | *- | *- | 4 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet4 | routed | - | 172.20.3.41/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet4 | routed | - | 172.20.3.43/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel4 | s2-host2 | switched | access | 10 | - | - | - | - | 4 | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.0.0.203/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.1.1.203/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.0.0.203/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 10.1.1.203/32
```
...
| 172.20.3.40 | 65200 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.20.3.42 | 65200 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.0.0.203:10010 | 10010:10010 | - | - | learned |
| 30 | 10.0.0.203:10030 | 10030:10030 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| A | 10.0.0.203:50001 | connected |
...
router bgp 65202
   ...
   neighbor 172.20.3.40 peer group IPV4-UNDERLAY-PEERS
   neighbor 172.20.3.40 remote-as 65200
   neighbor 172.20.3.40 description s2-spine1_Ethernet4
   neighbor 172.20.3.42 peer group IPV4-UNDERLAY-PEERS
   neighbor 172.20.3.42 remote-as 65200
   neighbor 172.20.3.42 description s2-spine2_Ethernet4
   neighbor 192.1.1.1 peer group MLAG-IPV4-UNDERLAY-PEER
   neighbor 192.1.1.1 description s2-leaf4
