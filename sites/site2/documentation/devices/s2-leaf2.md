...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet3 | routed | - | 172.20.3.37/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet3 | routed | - | 172.20.3.39/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.0.0.202/32 |
...
| 172.20.3.36 | 65200 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.20.3.38 | 65200 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.0.0.202:10010 | 10010:10010 | - | - | learned |
| 30 | 10.0.0.202:10030 | 10030:10030 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| A | 10.0.0.202:50001 | connected |
...
router bgp 65201
   ...
   neighbor 172.20.3.36 peer group IPV4-UNDERLAY-PEERS
   neighbor 172.20.3.36 remote-as 65200
   neighbor 172.20.3.36 description s2-spine1_Ethernet3
   neighbor 172.20.3.38 peer group IPV4-UNDERLAY-PEERS
   neighbor 172.20.3.38 remote-as 65200
   neighbor 172.20.3.38 description s2-spine2_Ethernet3
   neighbor 192.1.1.0 peer group MLAG-IPV4-UNDERLAY-PEER
   neighbor 192.1.1.0 description s2-leaf1
