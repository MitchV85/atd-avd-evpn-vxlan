...
| --------- | --------------- | ------------ | --------- |
| BORDER_LEAFS | Vlan4094 | 192.0.0.1 | Port-Channel1000 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet7 | routed | - | 172.20.3.49/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet7 | routed | - | 172.20.3.51/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.0.0.205/32 |
...
| Vlan3001 |  A  |  192.2.2.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  192.1.1.0/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  192.0.0.0/31  |  -  |  -  |  -  |  -  |  -  |
...
| 172.16.255.129 | 65000 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.16.255.131 | 65000 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.20.3.48 | 65200 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.20.3.50 | 65200 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.0.0.205:10010 | 10010:10010<br>remote 10010:10010 | - | - | learned |
| 30 | 10.0.0.205:10030 | 10030:10030<br>remote 10030:10030 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| A | 10.0.0.205:50001 | connected |
...
router bgp 65203
   ...
   neighbor 172.16.255.129 remote-as 65000
   neighbor 172.16.255.129 description s2-core1 VRF Default
   neighbor 172.16.255.129 route-map RM-WAN-OUT out
   neighbor 172.16.255.131 peer group IPV4-UNDERLAY-PEERS
   neighbor 172.16.255.131 remote-as 65000
   neighbor 172.16.255.131 description s2-core2 VRF Default
   neighbor 172.16.255.131 route-map RM-WAN-OUT out
   neighbor 172.20.3.48 peer group IPV4-UNDERLAY-PEERS
   neighbor 172.20.3.48 remote-as 65200
   neighbor 172.20.3.48 description s2-spine1_Ethernet7
   neighbor 172.20.3.50 peer group IPV4-UNDERLAY-PEERS
   neighbor 172.20.3.50 remote-as 65200
   neighbor 172.20.3.50 description s2-spine2_Ethernet7
   neighbor 192.1.1.1 peer group MLAG-IPV4-UNDERLAY-PEER
   neighbor 192.1.1.1 description s2-brdr2
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 10
      rd 10.0.0.205:10010
      rd evpn domain remote 10.0.0.205:10010
   ...
   vlan 30
      rd 10.0.0.205:10030
      rd evpn domain remote 10.0.0.205:10030
