...
| --------- | --------------- | ------------ | --------- |
| LeafPair1 | Vlan4094 | 192.0.0.1 | Port-Channel1000 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S2-SPINE1_Ethernet2 | routed | - | 172.20.3.33/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S2-SPINE2_Ethernet2 | routed | - | 172.20.3.35/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.0.0.201/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.1.1.201/32 |
...
| 172.20.3.32 | 65200 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.20.3.34 | 65200 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.0.0.201:10010 | 10010:10010 | - | - | learned |
| 30 | 10.0.0.201:10030 | 10030:10030 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| A | 10.0.0.201:50001 | connected |
...
router bgp 65201
   ...
   neighbor 172.20.3.32 peer group IPV4-UNDERLAY-PEERS
   neighbor 172.20.3.32 remote-as 65200
   neighbor 172.20.3.32 description s2-spine1_Ethernet2
   neighbor 172.20.3.34 peer group IPV4-UNDERLAY-PEERS
   neighbor 172.20.3.34 remote-as 65200
   neighbor 172.20.3.34 description s2-spine2_Ethernet2
   neighbor 192.1.1.1 peer group MLAG-IPV4-UNDERLAY-PEER
   neighbor 192.1.1.1 description s2-leaf2
