...
| --------- | --------------- | ------------ | --------- |
| LeafPair1 | Vlan4094 | 192.0.0.0 | Port-Channel1000 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s1-leaf1_Ethernet1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
| Ethernet4 | s1-host1_eth2 | *access | *10 | *- | *- | 4 |
| Ethernet6 | MLAG_PEER_s1-leaf1_Ethernet6 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 1000 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_S1-SPINE1_Ethernet3 | routed | - | 172.20.1.149/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_S1-SPINE2_Ethernet3 | routed | - | 172.20.1.151/31 | default | 9214 | False | - | - |
...
| Port-Channel1000 | MLAG_PEER_s1-leaf1_Po1000 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.0.0.102/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.1.1.101/32 |
...
| 172.20.1.148 | 65100 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - |
| 172.20.1.150 | 65100 | default | - | Inherited from peer group IPV4-UNDERLAY-PEERS | Inherited from peer group IPV4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65101
   ...
   neighbor 172.20.1.148 peer group IPV4-UNDERLAY-PEERS
   neighbor 172.20.1.148 remote-as 65100
   neighbor 172.20.1.148 description s1-spine1_Ethernet3
   neighbor 172.20.1.150 peer group IPV4-UNDERLAY-PEERS
   neighbor 172.20.1.150 remote-as 65100
   neighbor 172.20.1.150 description s1-spine2_Ethernet3
